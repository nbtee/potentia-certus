...
export function DashboardContent({ userEmail }: { userEmail: string }) {
  const { data: dataAssets, isLoading, error } = useDataAssets();
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          ...
          {isLoading ? (
            <div className="text-gray-600">Loading data assets...</div>
          ) : error ? (
            <div className="text-red-600">
              Error loading data assets: {error.message}
            </div>
          ) : (
